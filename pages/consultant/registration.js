...
export default function Registration() {
  return (
    ...
    <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
            <img class="w-8 h-8 mr-2" src="/images.png" alt="logo"/>
            Study Abroad  
        </a>
